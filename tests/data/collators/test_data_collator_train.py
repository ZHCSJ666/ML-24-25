...
from src.data.components.collators import DataCollatorTrain
...
def test_decoder_input_no_shift(default_tokenizers):
    encoder_tok, decoder_tok = default_tokenizers
...
def test_decoder_input_shift(default_tokenizers):
    encoder_tok, decoder_tok = default_tokenizers
